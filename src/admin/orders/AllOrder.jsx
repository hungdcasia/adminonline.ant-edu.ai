...
import { CopyButton, FilterComponent } from '../shared';
            ...
            customInput: (value, onChange) => {
                return (
                        <select className="custom-select mr-2" value={value} onChange={(e) => onChange(e.target.value)}>
                            ...
                            <option value='PENDING'>{orderStatusDS['PENDING']}</option>
                            <option value='CANCELLED'>{orderStatusDS['CANCELLED']}</option>
                            <option value='COMPLETED'>{orderStatusDS['COMPLETED']}</option>
                        </select>
                )
            }
        },
