...
const SurveyForm = ({ item, onSuccess, onCancel }) => {
    ...
    useEffect(() => {
        if (item.id != 0)
            surveyService.getDetail(item.id)
                .then(res => {
                    if (res.isSuccess) {
                ...
                <CCol xs='12'>
                    <nav className="navbar navbar-expand-lg navbar-light bg-light">
                        <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                            <span className="navbar-brand h4">{item.id == 0 ? 'Thêm survey' : 'Cập nhật survey'}</span>
                            ...
                            <CCard>
                                <CCardHeader className="container-fluid">
                                    ...
                                    <div className="float-right">
                                        <CButton type="link" onClick={() => { setEditQuestion(new questionModel()) }}>
                                            Thêm
                                        </CButton>
                                    </div>
                                </CCardHeader>
